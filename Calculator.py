...
entry.grid(row = 0, column = 0, columnspan = 3,  ipady = 2, pady = 3)
...
button_3 = tk.Button(master = frame, text = '2',padx = 15, pady = 5, width = 3, command=lambda : myclick(3))
button_3.grid(row = 1, column = 1, pady = 2)

button_4 = tk.Button(master = frame, text = '2',padx = 15, pady = 5, width = 3, command=lambda : myclick(4)) 
